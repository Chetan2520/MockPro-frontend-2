          ...
          <div className="mt-8 flex justify-around w-full flex-col lg:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="mt-6 text-gray-300 text-xl max-w-2xl leading-relaxed">
                ...
                on your coding skills, problem-solving abilities, and communication style.
              </p>

              {/* Modern CTA Buttons */}
              <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <MagneticButton className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-lg shadow-blue-500/20">
                  Start Free Trial
                </MagneticButton>
                <button
              ...
              <div className="mt-12">
                <div className="flex items-center gap-4 justify-center lg:justify-start">
                  ...
                  <p className="text-gray-300">
                    ...
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400 font-medium">500+ successful</span> candidates
                  </p>
                </div>
              </div>
            </div>
